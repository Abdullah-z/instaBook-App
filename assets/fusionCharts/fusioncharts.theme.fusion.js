(function (factory) {
  ...
  (() => {
        ...
        function modulesToDom(list, options) {
          ...
          for (var i = 0; i < list.length; i++) {
            ...
            if (indexByIdentifier !== -1) {
              ...
              options.byIndex = i;
              stylesInDOM.splice(i, 0, { identifier: identifier, updater: updater, references: 1 });
            }
    ...
    (() => {
      ...
      var insert_function_default = __webpack_require__.n(insert_function);
      var setAttributesWithoutAttributes = __webpack_require__(56);
      var setAttributesWithoutAttributes_default = __webpack_require__.n(
      ...
      var fusioncharts_theme_fusion = __webpack_require__(885);
      var fusioncharts_theme_fusion_default = __webpack_require__.n(fusioncharts_theme_fusion);
      var options = {};
      ...
      var update = injectStylesIntoStyleTag_default()(fusioncharts_theme_fusion_default(), options);
      const fusion_fusioncharts_theme_fusion =
        fusioncharts_theme_fusion_default() && fusioncharts_theme_fusion_default().locals
          ? fusioncharts_theme_fusion_default().locals
          : undefined;
      /*
 Fusion Theme v0.6
...
*/ var themeObject = {
        ...
        theme: {
          ...
          column2d: { chart: { paletteColors: '#5D62B5', placeValuesInside: '0' } },
          column3d: {
            chart: {
              showCanvasBase: '0',
              canvasBaseDepth: '0',
          ...
          area2d: { chart: { paletteColors: '#5D62B5', drawCrossLine: '1' } },
          bar2d: {
            chart: {
              placeValuesInside: '0',
          ...
          mscolumn2d: { chart: { showLegend: '1', legendIconSides: '4' } },
          mscolumn3d: {
            chart: {
              showLegend: '1',
              legendIconSides: '4',
          ...
          msarea: { chart: { drawCrossLine: '1', showLegend: '1', legendIconSides: '4' } },
          marimekko: {
          ...
          stackedcolumn2d: { chart: { showLegend: '1', legendIconSides: '4' } },
          stackedcolumn3d: {
            chart: {
              showLegend: '1',
              legendIconSides: '4',
          ...
          stackedarea2d: { chart: { drawCrossLine: '1', showLegend: '1', legendIconSides: '4' } },
          msstackedcolumn2d: { chart: { showLegend: '1', legendIconSides: '4' } },
          mscombi2d: {
            chart: {
              lineThickness: '2',
              anchorRadius: '4',
          ...
          msstackedcolumn2dlinedy: {
            ...
            lineset: [{ color: '#5D5D5D', anchorBgColor: '#5D5D5D' }],
          },
          scatter: {
            chart: {
              showCanvasBase: '0',
          ...
          angulargauge: {
            ...
            dials: { dial: [{ bgColor: '#000000', borderThickness: '0' }] },
          },
          bulb: { chart: { is3D: '0', placeValuesInside: '1', valueFont: 'Source Sans Pro' } },
          cylinder: { chart: { cylRadius: '50', cylYScale: '13' } },
          hled: {
            chart: {
              ledGap: '0',
              showGaugeBorder: '0',
          ...
          realtimearea: { chart: { showLegend: '1', legendIconSides: '2' } },
          realtimecolumn: { chart: { showLegend: '1', legendIconSides: '2' } },
          realtimeline: {
            chart: {
              lineThickness: '2',
              anchorRadius: '4',
          ...
          realtimestackedarea: { chart: { showLegend: '1', legendIconSides: '2' } },
          realtimestackedcolumn: { chart: { showLegend: '1', legendIconSides: '4' } },
          realtimelinedy: {
            chart: {
              lineThickness: '2',
              anchorRadius: '4',
          ...
          gantt: {
            ...
            categories: [
              {
                ...
                showHoverBand: '1',
                category: [{ fontcolor: '#5D5D5D', fontsize: '14', bgcolor: '#F3F3F3' }],
              },
            ],
            tasks: { showBorder: '0', showHoverEffect: '0' },
            processes: {
              fontcolor: '#5D5D5D',
              isanimated: '0',
              bgcolor: '#FFFFFF',
            ...
            text: { fontcolor: '#5D5D5D', bgcolor: '#FFFFFF' },
            datatable: {
              fontcolor: '#5D5D5D',
              bgcolor: '#FFFFFF',
              bgAlpha: '100',
              datacolumn: [{ bgcolor: '#FFFFFF' }],
            },
            connectors: [{ hoverThickness: '1.5' }],
            milestones: { milestone: [{ color: '#FFC533' }] },
          },
          logmscolumn2d: { chart: { showLegend: '1', legendIconSides: '4' } },
          logmsline: {
            chart: {
              lineThickness: '2',
              anchorRadius: '4',
          ...
          splinearea: { chart: { paletteColors: '#5D62B5', drawAnchors: '0' } },
          msspline: {
            chart: {
              lineThickness: '2',
              anchorRadius: '4',
          ...
          mssplinearea: { chart: { showLegend: '1', legendIconSides: '2', drawAnchors: '0' } },
          errorbar2d: {
            chart: {
              legendIconSides: '4',
          ...
          inversemsarea: { chart: { drawCrossLine: '1', showLegend: '1', legendIconSides: '2' } },
          inversemscolumn2d: { chart: { showLegend: '1', legendIconSides: '4' } },
          inversemsline: {
            chart: {
              lineThickness: '2',
              anchorRadius: '4',
          ...
          dragcolumn2d: {
            ...
            categories: [{ category: [{ fontItalic: '1' }] }],
            dataset: [{ data: [{ allowDrag: '1', alpha: '80' }] }],
          },
          dragline: {
            chart: {
              lineThickness: '2',
            ...
            categories: [{ category: [{ fontItalic: '1' }] }],
            dataset: [{ data: [{ allowDrag: '1', alpha: '80', dashed: '1' }] }],
          },
          dragarea: {
          ...
          heatmap: {
            ...
            colorrange: { gradient: '1', code: '#FFC533' },
          },
          boxandwhisker2d: {
            chart: {
              drawCustomLegendIcon: '0',
          ...
          candlestick: {
            ...
            categories: [
              { verticalLineColor: '#5D5D5D', verticalLineThickness: '1', verticalLineAlpha: '35' },
            ],
          },
          dragnode: {
            chart: {
            ...
            dataset: [{ color: '#5D62B5' }],
            connectors: [{ connector: [{ color: '#29C3BE' }] }],
          },
          msstepline: {
          ...
          multilevelpie: {
            ...
            category: [
              {
                color: '#EDEDED',
                category: [{ color: '#5D62B5', category: [{ color: '#5D62B5' }] }],
              },
            ],
          },
          selectscatter: {
          ...
          overlappedcolumn2d: { chart: { showLegend: '1', legendIconSides: '4' } },
          scrollbar2d: {
            chart: {
              showLegend: '1',
              legendIconSides: '4',
          ...
          sunburst: { chart: { textOutline: 1, unfocussedAlpha: 30, hoverFillAlpha: 100 } },
          chord: {
            chart: {
              drawCustomLegendIcon: 0,
          ...
          radialBar: { chart: { legendIconSides: '2', labelPadding: '6px 10px 6px 10px' } },
          radialBar: { chart: { legendIconSides: '2', labelPadding: '6px 10px 6px 10px' } },
          msstackedbar2d: { chart: { showLegend: '1', legendIconSides: '4' } },
          timeseries: {
            caption: {
              style: {
                text: {
            ...
            subcaption: {
              style: {
                text: { 'font-family': 'Source Sans Pro', 'font-size': 13, fill: '#999999' },
              },
            },
            crossline: { style: { line: { stroke: '#DFDFDF', 'stroke-width': 1 } } },
            chart: {
              paletteColors: '#5D62B5, #29C3BE, #F2726F, #FFC533, #62B58F, #BC95DF, #67CDF2',
              baseFont: 'Source Sans Pro',
              ...
              style: {
                ...
                canvas: { stroke: '#DFDFDF', 'stroke-width': 1 },
              },
            },
            tooltip: {
              style: {
                ...
                text: { 'font-size': '13px', color: '#5A5A5A' },
                header: {
                  color: '#5A5A5A',
                  'font-family': 'Source Sans Pro SemiBold',
                  padding: '0px',
            ...
            navigator: {
              scrollbar: {
                style: {
                  button: { fill: '#EBEBEB' },
                  track: { fill: '#FFFFFF', stroke: '#DFDFDF', 'stroke-width': 1 },
                  scroller: { fill: '#EBEBEB' },
                },
              },
              window: { style: { handle: { fill: '#EBEBEB' } } },
            },
            extensions: {
              customRangeSelector: {
                style: {
                  'title-text': { 'font-family': 'Source Sans Pro SemiBold' },
                  'title-icon': { 'font-family': 'Source Sans Pro SemiBold' },
                  label: { color: '#999999', 'font-family': 'Source Sans Pro SemiBold' },
                  'button-apply': {
                    color: '#FFFFFF',
                    'background-color': '#5648D4',
                    border: 'none',
                  },
                  'button-apply:hover': { 'font-family': 'Source Sans Pro SemiBold' },
                  'button-cancel': {
                    color: '#999999',
                    'background-color': '#FFFFFF',
                    border: 'none',
              ...
              standardRangeSelector: {
                style: {
                  ...
                  separator: { stroke: '#DFDFDF' },
                },
              },
            },
            legend: {
              style: {
                text: { fill: '#7C7C7C', 'font-size': 15, 'font-family': 'Source Sans Pro' },
              },
            },
            xaxis: {
              timemarker: [
                {
                  style: {
                    marker: { fill: '#62b58f', stroke: '#62b58f' },
                    'marker:hover': { fill: '#3e8464', stroke: '#3e8464', 'stroke-width': 1 },
                    'marker-box': { fill: '#F8B8B7', stroke: '#F8B8B7', 'stroke-width': 1 },
                    'marker-box:hover': { fill: '#F2726F', stroke: '#F2726F', 'stroke-width': 1 },
                    'marker-notch': { fill: '#F8B8B7', stroke: '#F8B8B7' },
                    'marker-notch:hover': { fill: '#F2726F', stroke: '#F2726F' },
                    'marker-line': { stroke: '#F8B8B7' },
                    'marker-line:hover': { stroke: '#F2726F' },
                    text: { fill: '#5F5F5F' },
                    'text:hover': { fill: '#5F5F5F' },
                  },
                },
              ],
              style: {
                title: { 'font-size': 15, 'font-family': 'Source Sans Pro', fill: '#999999' },
                'grid-line': { stroke: '#DFDFDF', 'stroke-width': 1 },
                'tick-mark-major': { stroke: '#DFDFDF', 'stroke-width': 1 },
                'tick-mark-minor': { stroke: '#DFDFDF', 'stroke-width': 0.75 },
                'label-major': { color: '#5A5A5A' },
                'label-minor': { color: '#8D8D8D' },
                'label-context': { color: '#5A5A5A' },
              },
            },
            plotconfig: {
              column: {
                style: { 'plot:hover': { opacity: 0.75 }, 'plot:highlight': { opacity: 0.75 } },
              },
              line: { style: { plot: { 'stroke-width': 1.5 }, anchor: { 'stroke-width': 0 } } },
              area: { style: { anchor: { 'stroke-width': 0 } } },
              candlestick: {
                style: {
                  bear: { stroke: '#F2726F', fill: '#F2726F' },
                  'bear:hover': { opacity: 0.75 },
                  'bear:highlight': { opacity: 0.75 },
                  bull: { stroke: '#62B58F', fill: '#62B58F' },
                  'bull:hover': { opacity: 0.75 },
            ...
            yaxis: [
              {
                style: {
                  title: { 'font-size': '15', 'font-family': 'Source Sans Pro', fill: '#999999' },
                  'tick-mark': { stroke: '#DFDFDF', 'stroke-width': 1 },
                  'grid-line': { stroke: '#DFDFDF', 'stroke-width': 1 },
                  label: { color: '#5A5A5A' },
                },
              },
      ...
      const fusion = { extension: themeObject, name: 'fusionTheme', type: 'theme' };
      FusionCharts.addDep(fusion);
    })();
  })();
});
